# SFX manifest — blade-orbit

Generated with MOSS-SoundEffect v2.0, 48 kHz mono Opus (96 kbps VBR, loudness-normalized; 100 inference steps).

| file | event | prompt |
|---|---|---|
| blade-throw.opus | throw | A quick whoosh of a small steel blade spinning through air, short swish with a faint metallic ring |
| blade-embed.opus | embed | A heavy wooden thunk as a knife blade embeds into a solid log target, sharp knock with a brief wood crunch |
| steel-clang.opus | miss-blade | A bright metallic clang of a knife blade ricocheting off hard steel, ringing decay |
| sigil-ward.opus | miss-marker | A dull resonant bonk on an enchanted warded surface, low descending warble with a faint magical hum |
| stage-win.opus | win | A short triumphant fanfare of rising brass and bell chimes, cheerful victory flourish |
| stage-lose.opus | lose | A short descending disappointed phrase of soft mallet notes falling in pitch |
| ui-click.opus | click | A short crisp wooden button tap, clean percussive click |
| ui-undo.opus | undo | A soft quick rising wooden tick, gentle reversal blip |
| ui-pause.opus | pause | A single soft muted wooden knock, low and calm |
